...
labels = [
    ...
    Label("Red", 0, 0, "Red", 1, True, False, (234, 30, 39)),
    Label("Green", 1, 1, "Green", 2, True, False, (101, 190, 110)),
    Label("Blue", 2, 2, "Blue", 3, True, False, (24, 92, 163)),
    Label("Yellow", 3, 3, "Yellow", 4, True, False, (224, 212, 28)),
]
